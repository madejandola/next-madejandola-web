...
export default function SobreMadejandolaPage() {
  return (
    <Layout>
      <div className={styles.container}>
        <Head>
          <title>Sobre Madejandola</title>
          <link rel="icon" href="/favicon.ico" />
        </Head>
        <main className={styles.main}>
          <div className="relative w-full overflow-hidden bg-gray-100">
            <div className="relative z-10 max-w-6xl p-12 mx-auto mt-20 prose prose-xl bg-white rounded-lg shadow-lg">
              ...
              <article className="donate">
                <div className="inner">
                  ...
                  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    ...
                    <Image alt="" border="0" src="https://www.paypal.com/es_MX/i/scr/pixel.gif" width="1" height="1" />
                  </form>
                </div>
              </article>
              <article>
