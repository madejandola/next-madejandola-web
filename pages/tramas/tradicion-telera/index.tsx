...
const PageTradicionTelera = () => {
    ...
    const image = "https://res.cloudinary.com/djoqdhbiv/image/upload/c_scale,q_auto:eco,w_1980/v1665276865/web/Tramas/Tradici%C3%B3n%20Telera/choque-guzman-12_fwlpqt.jpg"
    const imageBlur = "https://res.cloudinary.com/djoqdhbiv/image/upload/c_scale,q_auto:eco,w_5/v1665276865/web/Tramas/Tradici%C3%B3n%20Telera/choque-guzman-12_fwlpqt.jpg"
    return (
        <Layout title={title}>
